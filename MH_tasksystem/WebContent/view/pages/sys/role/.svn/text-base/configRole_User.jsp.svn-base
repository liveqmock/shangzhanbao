...
<script type="text/javascript" src="${root}/view/js/sys/role/configRole_User.js"></script>
		...
		<td colspan="3">
			<table align="center">
				...
				<td width="208px" align="center">
					<a class="easyui-linkbutton" iconCls="icon-ok" href="#" onclick="saveAuthorizeUser();">确认提交</a>
					<a class="easyui-linkbutton" iconCls="icon-no" href="#" onClick="closeWindow();return false;">取消</a>
				</td>
				</tr>
			</table>
		</td>

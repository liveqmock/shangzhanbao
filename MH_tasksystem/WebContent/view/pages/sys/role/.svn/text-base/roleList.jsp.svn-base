...
<script type="text/javascript" src="${root}/view/js/sys/role/roleList.js"></script>
<body class="easyui-layout">
	<div region="center" border="false">
		<table id="roleGrid" fit="true" ></table>
	</div>  
	    <!--  接收其他页面的窗口 --> 
	<div  id="otherInfoIframeWindow"  class="easyui-window" iconCls="icon-add" style="padding: 10px;width: 570px;height:365;" 
	   closed="true"  modal =truemaximizable="false" minimizable="false" collapsible="false" >

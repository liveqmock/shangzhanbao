...
<div  style="height: 60px;width: 100%"></div>
	<div class="success es">
	   ...
	   <div class="div9">
		...
		<input type='hidden' id='redpackageId' value='${redpackageId}'>
...
function ini(){
	var url = root + "/order_manager/key/paySuccessWithOrderChangeState?conSumerOrderData.orderCode="+$("#ordercode").val()+"&conSumerOrderData.state=1";
	$.ajax({
		type : 'POST',
		url : url,
		dataType : "text",

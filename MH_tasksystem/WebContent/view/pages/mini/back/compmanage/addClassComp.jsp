...
<span><a href="${root }/component_class/key/toAddComClass?componentData.id=${componentData.id}" target="frame_main" style="color: #2b6db4 ;">添加组件样式风格</a> </span>
</div>
  <div style="background-color: #AAAAAA;height: 1px;width: 980px;margin:20 0 20 10;"></div>
	<form  id="addComp" method="post" enctype="multipart/form-data" encoding="multipart/form-data" onsubmit="return checkSub($(this))"  action="${root}/component_class/key/addComponentClassData">
		...
		<input type="hidden" value="0"  name="componentClassData.Ident"/>
			<tr>
				<td>组件html源码：</td>
				<td colspan="3"><textarea  class="clob" rows="10" cols="4" style="width: 810px;resize: none;"  disabled="disabled">${componentData.clob}</textarea></td>
			</tr>
			...
			<lable style="color:red;font-weight: bold;font-size:14px;">${name}</lable>
			 ...
			 <tr >
				...
				<textarea   rows="6" cols="4"  name="componentClassData.pcclassCon"   class='conpc' notnull="不能为空"></textarea>
				</td>
				<td>
				<textarea   rows="6" cols="4"  name="componentClassData.ipadClassCon"   class='conip' notnull="不能为空"> </textarea>
				</td>
				<td>
				<textarea   rows="6" cols="4"  name="componentClassData.phoneClassCon"   class='conphone' notnull="不能为空"> </textarea>
				</td>
			</tr>
			...
			<tr>
				<td>样式风格&nbsp;&nbsp;&nbsp;</td>
				<td><input class="input-medium" style="height: 30px;" name="componentClassData.classType" type="text" placeholder="请输入样式风格" notnull="不能为空" id="csstype" /></td>
			</tr>
			<tr>
			<td>样式预览图</td>

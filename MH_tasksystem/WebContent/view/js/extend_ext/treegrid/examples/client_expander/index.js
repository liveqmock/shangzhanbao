Controller = function()
{
	...
	var toolBar = new Ext.Toolbar([
		{text:'录入',iconCls:'publish', tooltip:'录入酒店共享配额'},'-',
		{text:'变更',iconCls:'delete', tooltip:'变更已经发布的酒店共享配额'},'-',
		{text:'失效',iconCls:'retrieve', tooltip:'使已经发布的酒店共享配额失效'},'-',
		{text:'查看发布状态共享配额',iconCls:'retrieve', tooltip:'查看发布状态共享配额'},'-',
		{text:'查看审批状态共享配额',iconCls:'retrieve', tooltip:'查看审批状态共享配额'}
	]);
    // create the Grid

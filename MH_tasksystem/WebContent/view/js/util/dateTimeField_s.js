...
//txczhu    this.minuteel = document.createElement("SELECT");
//txczhu    this.secondel = document.createElement("SELECT");
...
//txc zhu       	if(this.minuteel.options.length>0) this.minuteel.selectedIndex = value.getMinutes();
//txc zhu         	if(this.secondel.options.length>0) this.secondel.selectedIndex = value.getSeconds();
        this.value = value;
        if(this.el){
...
//txc zhu         	var tdminuteel = this.el.child("td.x-date-minute");
 //txc zhu          	tdminuteel.appendChild(this.minuteel);
 //txc zhu          	for(var i=0;i<60;i++){
 //txc zhu          		var minuteOption = document.createElement("OPTION");
 //txc zhu          		minuteOption.value=i;
  //txc zhu         		minuteOption.text=i;
 //txc zhu          		this.minuteel.options.add(minuteOption);
  //txc zhu         	}
 //txc zhu          this.minuteel.options[this.value.getMinutes()].selected=true;
        
/*txc zhu        var tdsecondel = this.el.child("td.x-date-second");
...
//add end
 ...
 //txc zhu            dt.setMinutes(this.minuteel.options[this.minuteel.selectedIndex].value);
 //txc zhu             dt.setSeconds(this.secondel.options[this.secondel.selectedIndex].value);
 	    	this.setValue(dt);
 ...
 //txc zhu          this.value.setMinutes(this.minuteel.options[this.minuteel.selectedIndex].value);
 //txc zhu          this.value.setSeconds(this.secondel.options[this.secondel.selectedIndex].value);
        this.fireEvent("select", this, this.value);
    },

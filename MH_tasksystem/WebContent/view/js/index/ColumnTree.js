...
Ext.tree.ColumnTreeNodeUI = Ext.extend(Ext.tree.TreeNodeUI, {
    ...
    renderElements : function(n, a, targetNode, bulkRender){
		...
		//txc 将n.id替换成a.id,为什么呢？
        var buf = ['<li class="x-tree-node"><div ext:tree-node-id="',a.id,'" class="x-tree-node-el x-unselectable ', a.cls,'" unselectable="on">',
                '<div class="x-tree-col" style="width:',c.width-bw,'px;">',
                    '<span class="x-tree-node-indent">',this.indentMarkup,"</span>",
                    '<img src="', this.emptyIcon, '" class="x-tree-ec-icon x-tree-elbow">',
          			'<img src="', a.icon || this.emptyIcon, '" class="',(a.icon ? " x-tree-node-inline-icon" : ""),(a.iconCls ? " "+a.iconCls : ""),'" unselectable="on">',

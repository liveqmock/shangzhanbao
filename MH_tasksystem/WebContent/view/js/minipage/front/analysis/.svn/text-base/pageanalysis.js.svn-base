 ...
 * @return
 */
function findByTime(hour,info,classFlag){
	if(classFlag){
		if(classFlag=='1'){
			$("#threeDIV").attr("class","font_list_blue");
			$("#oneDIV").attr("class","font_list");
			$("#oneweekDiv").attr("class","font_list");
			$("#onedayDiv").attr("class","font_list");
		}else if(classFlag=='2'){
			$("#oneDIV").attr("class","font_list_blue");
			$("#threeDIV").attr("class","font_list");
			$("#oneweekDiv").attr("class","font_list");
			$("#onedayDiv").attr("class","font_list");
		}else if(classFlag=='3'){
			$("#oneweekDiv").attr("class","font_list_blue");
			$("#oneDIV").attr("class","font_list");
			$("#threeDIV").attr("class","font_list");
			$("#onedayDiv").attr("class","font_list");
		}else if(classFlag=='4'){
			$("#onedayDiv").attr("class","font_list_blue");
			$("#oneDIV").attr("class","font_list");
			$("#oneweekDiv").attr("class","font_list");
			$("#threeDIV").attr("class","font_list");
		}
	...
	$.ajax({
		...
		$("#allviewNum").html(chardata[1].onlyallviewNum);
		$("#oneeekviewNum").html(chardata[1].onlyoneweekdayviewNum);
		$("#onlyyesterdayviewNum").html(chardata[1].onlyyesterdayviewNum);
		chardata = null;
...
highcharts = function(chardata){
    ...
    yAxis: {
        ...
        tickInterval:5,//y轴单位间距
        min:0//Y轴最小值
        /*tickPositions: [0, 1, 2, 3] // 指定竖轴坐标点的值 
*/
    },

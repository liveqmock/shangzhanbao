...
function getsubmit(){
	...
	//拼接json字符串
	var dataJson = "[{'componentid':'b664e9cc203e0a1642e05d60b055eb65','name':'图文集合1的标题','content':'" + $("#title1").val() 
		+ "','taxis':'1','pageTemplateid':'40288104444ec71001444ec916dd0001','version':'1'},"
		+ "{'componentid':'b664e9cc203e0a1642e05d60b055eb65','name':'图文集合1的详述','content':'" + $("#content1").val() 
		+ "','taxis':'1','pageTemplateid':'40288104444ec71001444ec916dd0001','version':'1'}]";
	ajaxUtil(url + "?dataJson=" + encodeURIComponent(dataJson), null,function msg(request, status, error) {
		window.location.href=root+"/view/pages/mini/page/templateLeft/template1_left_step4_8.jsp";
...
function imgupload(uploadImg,filePath){
	...
	$.ajaxFileUpload({
		...
		success: function (data, status){//服务器成功响应处理函数
			mainframe.getElementById("div7_image1").src=root+filePath+"/"+data;
		}
	});
}

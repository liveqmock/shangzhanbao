...
Ext.DatePicker = Ext.extend(Ext.Component, {
    ...
    onRender : function(container, position){
        ...
        this.leftcr = new Ext.util.ClickRepeater(this.el.child("td.x-date-left a"), {//for destroy //change by guig
        ...
        this.rightcr = new Ext.util.ClickRepeater(this.el.child("td.x-date-right a"), {//for destroy //change by guig
...
//VVVVVVVVVVV add by guig //destroy some element
    onDestroy : function() {

...
c){if(f[a])return f[a];c.namespace=a;var d=f[a]={shost:f.BSHARE_SHOST_NAME,bhost:f.BSHARE_BUTTON_HOST,whost:f.BSHARE_WEB_HOST,defaultConfig:c,params:{type:0,publisherUuid:"",url:"",title:"",summary:"",content:"",pic:"",pics:"",video:"",vTag:"",vUid:"",vEmail:"",product:"",price:"0",brand:"",tag:"",category:"",template:"1",popcss:"",apvuid:"",apts:"",apsign:"",admtest:!1},isReady:!1,completed:!1,curb:0,preb:-1,
		entries:[],counters:[],viewInfo:null};d.config={};d.elems={powerBy:'<div id="bsPower" style="float:right;text-align:right;overflow:hidden;height:100%;"><a class="bsSiteLink" style="font-size:10px;vertical-align:text-bottom;line-height:24px;cursor:pointer;" href="'+
d.whost+'" target="_blank"><span style="font-size:10px;vertical-align:text-bottom;"><span style="color:#f60;">b</span>Share</span></a></div>'};for(var m in d.defaultConfig)d.config[m]=d.defaultConfig[m];d.imageBasePath=d.shost+"/frame/images/";d.jsBasePath=d.shost+"/b/";
...
d.fc="";
d.createFlashObj=function(){
	if(!e.getElemById("bshareFS")){
		var a=d.shost+"/flash/bfc.swf";
		i.body.appendChild(
				e.createElement("div","","","height:0;line-height:0;font-size:0;",
						'<object id="bshareFS" type="application/x-shockwave-flash" data="'+a+
						'" width="0" height="0"><param name="movie" value="'+a+
						'"/><param name="allowScriptAccess" value="always"/><param name="allowNetworking" value="all"/></object>'));
		l.fCB=function(){
			b.viewed||d.view()
		}
	}
};
d.updateFC=function(a){
	try{
		var b=j.appName.indexOf("Microsoft")!=-1?f.bshareFS:i.bshareFS;
		d.fc=b.bSyncInfo(a||"")
	}catch(c){}
};
d.initAdm=function(){
	var a=e.createElement("a"),b,c,m;
	m=["rayli.com"];
	a.href=f.location.href;
	a=a.host;
	for(b=0,c=m.length;b<c;++b)
		if(a.indexOf(m[b])>-1){d.params.admtest=!0;break}if(!d.params.admtest)return"";d.admIdsObj=[];m=i.getElementsByTagName("object");for(b=0,c=m.length;b<c;++b)a=m[b].id,a=j.appName.indexOf("Microsoft")!=-1?e.getElemById(a):i[a],a.objVisible&&(d.admIdsObj[b]=a);if(d.admIdsObj.length!=0)d.eleInViewportEvent=function(){for(b=0,c=d.admIdsObj.length;b<c;b++){var a=d.admIdsObj[b];if(a&&e.eleInViewport(a)&&!a.isViewed)try{a.objVisible(),a.isViewed=
...
"";if(i.location.href.indexOf(b.whost+"/moreStyles")<0)e.promote=!1};
b.writeButton=function(){
	var a="",
		d={0:0,1:[110,85],10:[90,51],11:[82,82]},
		f={0:16,1:24,10:21,11:49},
		g=b.imageBasePath,h=e.style,i=e.image,l=e.showShareCount,n=e.width,o=e.height;
	/^(3|4|5)$/.test(h)||(a='<div class="bsPromo bsPromo1"></div>');
	h>1&&h<6?b.writeBshareDiv(a):h==-1?(j.getElem(k,"div","bshare-custom",function(a){
		if(!a.childNodes[0].className||a.childNodes[0].className.indexOf("bsPromo")<0){var c=j.createElement("div",
...
c||"";b.click();b.disappear();b.prepare();

if(!b.loadPlus||!b.loadPlus()){
	var g;
	if(c=="bsharesync")
		g=[b.whost,"/bsyncShare?site=",c].join(""),b.updateCounter(),b.shareStats(c),j.submitForm(g,a,"_blank");
	else if(c=="email")
		g=[b.bhost,"/bshareEmail"].join(""),b.shareStats(c),j.submitForm(g,a,"_blank");
	else if(c=="clipboard")
		j.copy2Clipboard(),b.shareStats(c);
	else if(c=="favorite")
		j.add2Bookmark(),b.shareStats(c);
	else if(c=="printer")
		j.add2Printer(),b.shareStats(c);
	else if(c=="weixin"){
		g=b.bhost+"/barCode?site=weixin";
		for(var h in a)
			!/content|target/.test(h)&&typeof a[h]!="function"&&(g+="&"+h+"="+j.encode(a[h]));
		k.getElementById("bsWXBox")||b.createBox(b.boxConfigWX);
		b.getFrame(b.boxConfigWX).innerHTML='<img style="width:178px;height:178px;margin:21px;display:inline-block;" src="'+g+'" />';
		b.display(!1,b.boxConfigWX)
	}else{
		if(l.bShareLoad){
			for(h in g=b.bhost+"/bshare_redirect?site="+c,a){
				!/content|target/.test(h)&&typeof a[h]!="function"&&(g+="&"+h+"="+j.encode(a[h]));
			}
		}
		else
			(g=i.BS_PURL_MAP[c])
			||
			alert(b.iL8n.loadFailed),
			c=="gmw"?
				g=j.replaceParam("${URL}",a.url.replace("http://",""),g)
				:a.url&&(g=j.replaceParam("${URL}",a.url,g)),
				g=j.replaceParam("${TITLE}",a.title,g),
				g=j.replaceParam("${CONTENT}",a.summary,g),
				g=j.replaceParam("${IMG}",a.pic,g),g=j.replaceParam("${VIDEO}",a.video,g);
i.open(
		g,"","height=600,width=800,top=100,left=100,screenX=100,screenY=100,scrollbars=yes,resizable=yes"
		)
		}
}
};b.show=function(){b.load()};b.onLoad=function(){j.getElem(k,"a","bshareDiv",function(a,c){j.getElem(a,"div","buzzButton",function(a){a.onclick=
function(a){return function(c){b.more(c,a);return!1}}(c)})});var a=e.showShareCount;if(e.style==0){var d=j.getElem(k,"div","buzzButton")[0].offsetWidth;a&&(d+=41);j.getElem(k,"a","bshareDiv",function(a){a.style.width=d+"px"})}
var f=b.entries.length;
...
b.imageBasePath+"bshare_box_sprite2.gif) no-repeat 0 -606px;}div.bshare-custom .bsPromo.bsPromo2{background:url("+b.imageBasePath+"bshare_promo_sprite.gif) no-repeat;cursor:pointer;}");b.writeButton();a.type==15&&b.filterECPlats()};b.loadButtonStyle=function(){if(a.type!=15){var c,d=e.style;if(e.beta)c=b.jsBasePath+"styles/bshareS888.js?v=20140717";else if(e.popjs)c=e.popjs;else if(e.style!=-1&&(c=b.jsBasePath+"styles/bshareS"+(d>1&&d<6?d:1)+".js?v=20140717",e.pop==-1&&(d<=1||d>=6)))c="";c&&j.loadScript(c)}};b.international=
function(a){e.lang=="zh"?a():j.loadScript(b.jsBasePath+"langs/bs-lang-"+e.lang+".js?v=20140717",a)};b.start=function(){j.loadEngine&&(j.loadEngine(f),b.createFlashObj(),b.loadOptions(),b.international(function(){if(!b.completed){if(j.isUndefined(e.text)||e.text===null)e.text=e.style==0?b.iL8n.shareTextShort:b.iL8n.shareText;a.type!=1&&b.renderButton();j.createShareBox(f);if(a.type==15)b.boxConfig=b.boxConfigEC;b.createBox();e.mdiv>=0&&a.type!=15&&j.loadScript(b.jsBasePath+"components/bsMore.js?v=20140717");if(a.type==
1)return b.load(),!1;b.loadButtonStyle();b.onLoad();b.prepare(0);setTimeout(function(){l.viewed||b.view();setTimeout(function(){l.bShareLoad||j.loadScript(b.jsBasePath+"components/bsPlatforms.js?v=20140717")},3E3)},3E3);b.completed=!0}}))};b.init=function(){if(!b.isReady)b.isReady=!0,j.loadScript(b.jsBasePath+"engines/bs-engine.js?v=20140717",b.start)};j.loadScript(b.jsBasePath+"components/bsStatic.js?v=20140717")}})("bShare",window,document);(function(f,i,k){if(!(i.bShareControl.count>0)){i.bShareControl.count+=1;var j=i.bShareUtil,f=i[f],l=f.config;f.isLite=!0;f.customization.type="lite";f.writeBshareDiv=function(b,e){j.getElem(k,"a","bshareDiv",function(a){if(b)a.innerHTML=b;else if(a.innerHTML.length<24)a.innerHTML="";a.onclick=function(){return!1};a.style.cssText=(l.inline?"":"display:block;")+"text-decoration:none;padding:0;margin:0;"+e||""})};j.ready(f.init)}})("bShare",window,document);(function(){var f=window.bShare;if(!f)f=window.bShare={};f.pnMap={115:["115\u6536\u85cf\u5939",0],"139mail":["139\u90ae\u7bb1",2],"9dian":["\u8c46\u74e39\u70b9",6],baiducang:["\u767e\u5ea6\u641c\u85cf",7],baiduhi:["\u767e\u5ea6\u7a7a\u95f4",8],bgoogle:["Google\u4e66\u7b7e",10],bsharesync:["\u4e00\u952e\u901a",16],caimi:["\u8d22\u8ff7",17],cfol:["\u4e2d\u91d1\u5fae\u535a",18],chouti:["\u62bd\u5c49",20],clipboard:["\u590d\u5236\u7f51\u5740",21],cyolbbs:["\u4e2d\u9752\u8bba\u575b",22],cyzone:["\u521b\u4e1a\u5427",23],delicious:["\u7f8e\u5473\u4e66\u7b7e",24],dig24:["\u9012\u5ba2\u7f51",25],digg:["Digg",26],diglog:["\u5947\u5ba2\u53d1\u73b0",27],diigo:["Diigo",29],douban:["\u8c46\u74e3\u7f51",30],dream:["\u68a6\u5e7b\u4eba\u751f",31],duitang:["\u5806\u7cd6",32],eastdaymb:["\u4e1c\u65b9\u5fae\u535a",33],email:["\u7535\u5b50\u90ae\u4ef6",

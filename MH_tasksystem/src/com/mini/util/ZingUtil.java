...
import java.awt.image.BufferedImage; 
 ...
 public  class ZingUtil{ 
   ...
   public static String  zing(PageData data,String pathurl, String myPath, int width , int height  ){
           String url=pathurl+data.getPageInfoExtra().getDomain();//完整路径
           //二维码的图片格式 
           String format = "gif"; 
        ...
        try {
            ...
            File outputFile = new File(myPath); 

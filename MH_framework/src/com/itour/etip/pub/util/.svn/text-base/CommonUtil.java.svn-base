...
public class CommonUtil {
	...
	// / 系统名称
	public static final String SYSTEM_NAME = "rdf";
	...
	public static final String IS_NOT_NULL = SPACE + IS + SPACE + NOT + SPACE
			+ NULL;
	...
	public static final String INSERT = "INSERT" + SPACE + "INTO" + SPACE;
	public static final String UPDATE = "UPDATE" + SPACE;
	public static final String DELETE = "DELETE" + SPACE + "FROM" + SPACE;
	...
	public static final String XDOC_ROOT = "RDFFRAME";
	...
	public static final String XML_PROP_SOURCE = "rdfframae";
	...
	public static final String PVAL_SOURCE = "urn=www-rdfframe-cn";
	public static final String PVAL_VERSION = "1.0";

	public static final String STR_XML_HEAD = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"

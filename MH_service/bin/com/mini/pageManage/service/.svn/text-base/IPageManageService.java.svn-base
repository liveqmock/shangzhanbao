...
public interface IPageManageService extends IService {
     ...
     * @exception/throws
     * @see   IPageManageService#getTempPicByPageId(String)
     * @since 
     */
    ...
    public void  updatePage(PageData data);
      ...
      * @see IPageManageService#createGoodsCss
      * @since vmaque1.6
      */
      ...
      * @see   IPageManageService#copyPage(PageData)
      * @since vmaque1.7
      */

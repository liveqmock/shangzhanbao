 ...
 * @since [产品/模块版本] （可选）
 */
public interface IComponentBusiness extends IBusiness {
     ...
     * @exception/throws
     * @see IComponentBusiness#searchComponentAndPic(ComponentData)
     * @since
     */
     ...
     * @return List<ComponentData> 组件集合
     * @exception/throws
     * @see IComponentBusiness#searchComponent(ComponentData)
     * @since
     */
     ...
     * @exception/throws
     * @see IComponentBusiness#searchComponentById(String)
     * @since
     */
     ...
     * @return String
     * @exception/throws
     * @see IComponentBusiness#addComponent(ComponentData)
     * @since
     */
     ...
     * @update
     * @param pageRoll 分页
     * @param componentData 组件对象 存放条件查询的参数
     * @return List<ComponentData> 组件集合
     * @exception/throws
     * @see IComponentBusiness#searchComponent(PageRoll, ComponentData)
     * @since
     */

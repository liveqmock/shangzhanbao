...
public class ComponentClassService extends BaseService implements IComponentClassService{
    ...
    public List<ComponentClassData> getAllCompId(ComponentData data){
        return  componentClassBusiness.getAllCompId(data);
    }
    /**
     * 
    ...
    public String ajaxFindComponentClassData(ComponentClassData data){
        return  componentClassBusiness.ajaxFindComponentClassData(data);
    }
    /**
     * 
     *增加修改组件样式表<br>
    ...
    public String componentClassDataAddUpdate(ComponentClassData data){
        return componentClassBusiness.componentClassDataAddUpdate(data);
    ...
    public String componentClassDatadelete(ComponentClassData data){
        return componentClassBusiness.componentClassDatadelete(data);
    }
    ...
    public String deleteCom(ComponentClassData data){
        return componentClassBusiness.deleteCom(data);
    }
    /**
     * 
     *  根据主键查询信息<br>
    ...
    public ComponentClassData getComponentClassDataById(ComponentClassData data){
        return componentClassBusiness.getComponentClassDataById(data);
    }

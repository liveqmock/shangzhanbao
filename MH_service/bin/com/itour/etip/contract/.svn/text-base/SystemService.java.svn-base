...
import com.itour.etip.pub.kit.system.SystemUtil;
 ...
 */
@WebService(endpointInterface = "com.itour.etip.contract.ISystemService")
public class SystemService implements ISystemService {
	 ...
	 */
	public long getDiskFreeSpace(@WebParam(name = "pszDrive")
	String pszDrive) {
		return SystemUtil.getDiskFreeSpace(pszDrive);
	}
	...
	public MemoryUsageBean getMemoryUsage() {
		return SystemUtil.getMemoryUsage();
	}
	...
	public OsInfoBean getOsInfomation() {
		return SystemUtil.getOsInfomation();
	}
	...
	public DiskUsageBean getDiskUsage() {
		return SystemUtil.getDiskUsage();
	}
	...
	public List<DiskUsageBean> getAllDiskUsage() {
		return SystemUtil.getAllDiskUsage();
	}
	...
	public Date getServerTime() {
		return SystemUtil.getServerTime();
	}
	 ...
	 *            时区
	 */
	public void setServerTimeZone(@WebParam(name = "timeZone")
	int timeZone) {
		SystemUtil.setServerTimeZone(timeZone);
	}
	...
	public int getServerTimeZone() {
		return SystemUtil.getServerTimeZone();
	}
	 ...
	 *            NTP服务器的情况
	 */
	public void setServerTimeFromNtp(@WebParam(name = "ntpTimeBean")
	NtpTimeBean ntpTimeBean) {
		SystemUtil.setServerTimeFromNtp(ntpTimeBean);
	}

...
function writeIframe()
{
    ...
    "    <table id=tableDay height=120 width=140 border=0 cellspacing=1 cellpadding=0>";
         ...
         " type=button value='&nbsp;清空&nbsp;' onclick='parent.emptying()'></td></tr><tr><td colspan='7'></td></tr>";
    if(WebCalendar.timeShow){
	strIframe += "<tr><td  class=out>&nbsp;</td><td  class=out >时</td><td  class=out  colspan=2><select id='hour'><option value='00'>00</option><option value='01'>01</option><option value='02'>02</option>"+
	"<option value='03'>03</option><option value='04'>04</option><option value='05'>05</option><option value='06'>06</option>"+
	...
	"</select></td>"+
	"<td  class=out >分</td><td  class=out colspan=2><select id='minute'>"+
    ...
    "<option value='29'>29</option><option value='30'>30</option><option value='31'>31</option><option value='32'>32</option><option value='33'>33</option>"+
    "<option value='34'>34</option><option value='35'>35</option><option value='36'>36</option><option value='37'>37</option><option value='38'>38</option>"+
    ...
    "<option value='44'>44</option><option value='45'>45</option><option value='46'>46</option><option value='47'>47</option><option value='48'>48</option>"+
    "<option value='49'>49</option><option value='50'>50</option><option value='51'>51</option><option value='52'>52</option><option value='53'>53</option>"+
    "<option value='54'>54</option><option value='55'>55</option><option value='56'>56</option><option value='57'>57</option><option value='58'>58</option>"+
...
function calendarTime(e) //主调函数
{
    ...
    e=Browser.isIE?window.event.srcElement:e.target;
     ...
     writeIframe();
  if(WebCalendar.timeShow){
     WebCalendar.iframe2.document.getElementById("hour").value = WebCalendar.hour;
	 WebCalendar.iframe2.document.getElementById("minute").value =  WebCalendar.minute;
  }
...
{ 
    if(WebCalendar.objExport)
    {
        ...
        if(WebCalendar.timeShow)
        {   
			 var hour =  WebCalendar.iframe2.document.getElementById("hour").value;
		     var minute =  WebCalendar.iframe2.document.getElementById("minute").value;
		    
          //  var h = new Date().getHours(), m = new Date().getMinutes(), s = new Date().getSeconds();
             WebCalendar.hour = hour;
			 WebCalendar.minute = minute;
			 var h = hour, m = minute, s = "00";

...
public interface IProductService extends IService {
     ...
     *         2014-3-14
     * @update
     * @param productData 条件查询参数
     * @return List<ProductData> 服务集合
     * @exception/throws
     * @see IProductService#getAllProduct(ProductData)
     * @since
     */
     ...
     * @return List<ProductData> 服务集合
     * @exception/throws
     * @see IProductService#getProductNoDomain(String)
     * @since
     */
     ...
     * @return List<ProductData> 服务集合
     * @exception/throws
     * @see IProductService#getProductNoPage(String)
     * @since
     */
     ...
     * @return List<ProductData> 服务集合
     * @exception/throws
     * @see IProductService#getProductByPageId(String)
     * @since
     */
     ...
     * @exception/throws 
     * @see   IProductService#getAllProductPageRoll(String, PageRoll)
     * @since vmaque1.5
     */

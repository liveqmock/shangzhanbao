...
/**
 * 
 * 收款账号操作business层接口<br> 
 *
 * @author 左香勇
 * 
 */
public interface IAccountNumberBusiness {
     ...
     * @see   IAccountNumberBusiness#addAccountNumberData(AccountNumberData)
     * @since vmaque1.9
     */
     ...
     * @see   IAccountNumberBusiness#queryAccountNumberDataByid(id)
     * @since vmaque1.9
     */
     ...
     * @see   IAccountNumberBusiness#queryAccountNumberDataByuserId(userId)
     * @since vmaque1.9
     */
     ...
     * @update 
     * @param accountNumberData    收款账号实体信息
     * @see   IAccountNumberBusiness#deleteAccountNumberData(accountNumberData)
     * @since vmaque1.9
     */
     ...
     * @see   IAccountNumberBusiness#editAccountNumberData(accountNumberData)
     * @since vmaque1.9
     */
     ...
     * @see   IAccountNumberBusiness#getAccountNumberDataBytype(AccountNumberData)
     * @since vmaque2.0
     */
